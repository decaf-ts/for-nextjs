...
- `update-scripts` – downloads the latest GitHub workflows, configs, and templates from the [for-nextjs](https://github.com/decaf-ts/for-nextjs) template repository.
